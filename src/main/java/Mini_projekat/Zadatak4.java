...
//`String` klasa u Javi. Napišite program koji omogućava korisniku da menja vrednosti unutar
//komande dok se ne zamene sve vrednosti u komandi. Komanda iz primera je komanda koja pokreće
//Locust skriptu za stres testiranje. Ukoliko ste zainteresovani, preporučuje se da istražite
//alat Locust.
//Komanda je obican String, a vrednosti koje se menjaju su reči napisane velikim slovima i
//ispred svake od njih se nalazi znak $. Ako u skripti postoji barem jedan znak $, to znači
//da još uvek postoje promenljive koje treba zameniti.
...
//Komanda: locust -f login_stress_test.py -u 1000 -r 5  -t 100 --headless –host  https://cms.demo.katalon.com/ --html login_stress_report.html
        ...
        while (komanda.contains("$")) {
            ...
            System.out.print("Unesite naziv promenjive za zamenu: ");
