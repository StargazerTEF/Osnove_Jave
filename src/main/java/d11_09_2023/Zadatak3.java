...
//metodu ucitajVideo kojoj se prosledjuje referenca do videa koji se pusta. Trenutno vreme kada se ucita video
//se postavlja na nulu. Treba videu da povecamo broj pregleda!
...
//metodu premotajUnapred - metoda koja premotava trenutno vreme videa za 10s. Vodite racuna da ne predjete duzinu
//videa.
...
//Objasnjenje v6tuOipj5mk je id videa.
        ...
        Video video = new Video("v6tuOipj5mk", "Ariana Grande - Positions (official video)", 125, 22, 31, 34893481);
        YoutubePlayer player = new YoutubePlayer();
        player.loadVideo(video);

        System.out.print("Unesite brzinu interneta (Mb/s): ");
        int netSpeed = s.nextInt();

        player.setQuality(netSpeed);
        video.view();
        video.like();
        video.view();
        video.dislike();
        player.increaseSound();
        player.decreaseSound();
